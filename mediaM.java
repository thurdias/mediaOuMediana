...
public class mediaM {                                                                 // Explicação:
                                                                                      // Método principal com o método do bufferedreader/inputstreamreader
	...
	if (a < b)                                                                       // A mediana sempre será determinada pelo menor número (A/B) para atender o menor inteiro possível para C
	    ...
	    System.out.println(2*b-a);                                                   // Como queremos descobrir a variável c, e não podemos declarar meia variável como na expressão anterior
